...
import type { ShowcasePreviewLook } from "@/services/showcasePreview";
...
export function HomeClient({ looks }: { looks: ShowcasePreviewLook[] }) {
      ...
      <div className="mx-auto max-w-shell px-margin-mobile py-12 md:px-margin-desktop">
        ...
        >
          ...
          <div className="min-w-0">
            <LiveScanPreview looks={looks} onOpenScan={handleImageReady} />
          </div>
        </section>
