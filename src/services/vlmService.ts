...
const FASHION_PROMPT = [
  ...
  "e-commerce search query. Specify: Gender (Erkek/Kadın/Unisex), Specific Item",
  "Subtype, Dominant Color, and Fit/Cut. Map what you see to RICH retail terms —",
  "never thin generics. Canonical GOOD examples (copy this shape):",
  "- male/unisex crew-neck tee → \"Siyah Erkek Bisiklet Yaka Tişört\"",
  "- female cream one-shoulder / asymmetric crop → \"Krem Tek Omuz Crop Top\"",
  "  (NOT \"Krem Üst\", NOT \"Body\")",
  "- blue baggy / wide cargo denim → \"Mavi Kargo Cepli Wide Leg Jean\"",
  "  (NOT \"Mavi Jean\", NOT \"Deri Şort\")",
  "Other GOOD shapes: \"Kadın Krem Asimetrik Yaka Bluz\", \"Deri Biker Ceket\".",
...
const SYSTEM_PROMPT = [
  ...
  "   Outerwear, Apparel, Giyim. Zengin alt tip yaz — kanonik örnekler:",
  '   erkek/unisex tişört → "Siyah Erkek Bisiklet Yaka Tişört";',
  '   krem tek omuz crop → "Krem Tek Omuz Crop Top";',
  '   mavi kargo wide-leg jean → "Mavi Kargo Cepli Wide Leg Jean".',
  '   "Body" veya "Deri Şort" uydurma.',
