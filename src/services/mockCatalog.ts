...
const streetwearItems: DetectedItem[] = [
  {
    ...
    itemType: "Jacket",
    category: "clothing",
    attributes: "Matte Black • Cropped Moto",
    description:
  ...
  },
  {
    ...
    itemType: "Top",
    category: "clothing",
    attributes: "Off-White • Ribbed Knit",
  ...
  },
  {
    ...
    itemType: "Sneakers",
    category: "clothing",
    attributes: "Off-White • Platform Sole",
...
const glamMakeupItems: DetectedItem[] = [
  {
    ...
    itemType: "Lipstick",
    category: "beauty",
    attributes: "True Red • Velvet Matte",
  ...
  },
  {
    ...
    itemType: "Eyeshadow",
    category: "beauty",
    attributes: "Copper Bronze • Shimmer",
  ...
  },
  {
    ...
    itemType: "Eyeliner",
    category: "beauty",
    attributes: "Jet Black • Liquid Wing",
  ...
  },
  {
    ...
    itemType: "Earrings",
    category: "clothing",
    attributes: "Gold Tone • 40mm Hoop",
...
const genericItems: DetectedItem[] = [
  ...
  },
  {
    ...
    itemType: "Bag",
    category: "clothing",
    attributes: "Black • Structured Leather",
...
const tailoringItems: DetectedItem[] = [
  {
    ...
    itemType: "Blazer",
    category: "clothing",
    attributes: "Midnight Navy • Peak Lapel",
    description:
      "Sharply tailored single-breasted blazer with peak lapels and a defined shoulder.",
    confidence: 0.95,
  ...
  {
    id: "tl-trousers",
    label: "Pleated Straight Trousers",
    itemType: "Trousers",
    category: "clothing",
    attributes: "Midnight Navy • Front Pleat",
    description: "High-rise pleated trousers with a clean break and pressed centre crease.",
    confidence: 0.92,
    ...
    alternatives: [
      {
        ...
        title: "High Waist Pleated Pants",
        brand: "Trendyol",
        merchant: "Trendyol",
        price: 26.9,
        currency: "USD",
  ...
  {
    id: "tl-boots",
    label: "Leather Chelsea Boots",
    itemType: "Boots",
    category: "clothing",
    attributes: "Dark Brown • Chunky Sole",
    description: "Polished leather Chelsea boots with elastic side gussets and a lug sole.",
    confidence: 0.88,
    ...
    alternatives: [
      {
        id: "tl-boots-alt-1",
        title: "Chunky Sole Chelsea Boot",
        brand: "Trendyol",
        merchant: "Trendyol",
        price: 44.9,
        currency: "USD",
  ...
  {
    id: "tl-tote",
    label: "Structured Leather Tote",
    itemType: "Bag",
    category: "clothing",
    attributes: "Espresso • Top Handle",
    description: "Boxy top-handle tote in grained leather with slim gold hardware.",
    confidence: 0.86,
...
const softMinimalItems: DetectedItem[] = [
  {
    ...
    itemType: "Sweater",
    category: "clothing",
    attributes: "Oat Cream • Cable Knit",
    description: "Oversized cable-knit sweater in an undyed oat wool with dropped shoulders.",
    confidence: 0.94,
    ...
    alternatives: [
      {
        id: "sm-knit-alt-1",
        title: "Soft Cable Knit Pullover",
        brand: "Trendyol",
        merchant: "Trendyol",
        price: 29.9,
        currency: "USD",
  ...
  {
    id: "sm-scarf",
    label: "Printed Silk Neck Scarf",
    itemType: "Scarf",
    category: "clothing",
    attributes: "Terracotta • Pure Silk",
    description: "Lightweight silk twill scarf knotted at the neck in warm terracotta tones.",
    confidence: 0.89,
  ...
  },
  {
    ...
    itemType: "Earrings",
    category: "clothing",
    attributes: "Freshwater Pearl • Gold Post",
    description: "Single freshwater pearl suspended from a slim gold-tone post.",
    confidence: 0.81,
  ...
  {
    id: "sm-lip",
    label: "Rosewood Tinted Lip Balm",
    itemType: "Lip balm",
    category: "beauty",
    attributes: "Rosewood • Sheer Satin",
    description: "Muted rosewood wash with a cushiony satin finish and no visible edge.",
    confidence: 0.78,
