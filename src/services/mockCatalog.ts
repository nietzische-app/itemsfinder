...
const bikerLookItems: CatalogItem[] = [
  {
    ...
    alternatives: [
      ...
      },
      {
        ...
        imageUrl: thumb("Cropped Leather", "#3d3d46", "#17171c"),
        matchType: "alternative",
        similarity: 0.81,
        inStock: true,
      },
  ...
  },
  {
    ...
    alternatives: [
      ...
      },
      {
        ...
        imageUrl: thumb("Sweetheart Body", "#33333a", "#161619"),
        matchType: "alternative",
        similarity: 0.79,
        inStock: true,
      },
  ...
  },
  {
    ...
    alternatives: [
      ...
      },
      {
        ...
        imageUrl: thumb("Stretch Jean", "#3a5170", "#1a2740"),
        matchType: "alternative",
        similarity: 0.8,
        inStock: false,
      },
...
const longCoatItems: CatalogItem[] = [
  {
    ...
    alternatives: [
      ...
      },
      {
        ...
        imageUrl: thumb("Trench Coat", "#3a3a45", "#17171d"),
        matchType: "alternative",
        similarity: 0.8,
        inStock: true,
      },
  ...
  },
  {
    ...
    alternatives: [
      ...
      },
      {
        ...
        imageUrl: thumb("Mom Jean", "#7093ba", "#3d5c82"),
        matchType: "alternative",
        similarity: 0.78,
        inStock: true,
      },
    ...
    alternatives: [
      {
        ...
        imageUrl: thumb("Heeled Sandal", "#36363e", "#141418"),
        matchType: "alternative",
        similarity: 0.82,
        inStock: true,
      },
...
const blackBlazerItems: CatalogItem[] = [
  {
    ...
    alternatives: [
      ...
      },
      {
        ...
        imageUrl: thumb("Relaxed Blazer", "#3b3b45", "#17171c"),
        matchType: "alternative",
        similarity: 0.84,
        inStock: true,
      },
  ...
  },
  {
    ...
    alternatives: [
      ...
      },
      {
        ...
        imageUrl: thumb("Liquid Lip", "#cf3a4d", "#84121f"),
        matchType: "alternative",
        similarity: 0.78,
        inStock: true,
      },
